...
from activeeval.measures import Accuracy
...
for h5_path in h5_paths:
    ...
    fig.savefig(dataname + '_accuracy_stacked.pdf', bbox_inches='tight', dpi=72)

all_df = pd.concat(all_dfs)

fig = plot_results(all_df, label_budget=2000)
fig.savefig('mse_2000-queries_accuracy_barplot.pdf', bbox_inches='tight', dpi=72)

fig = plot_results(all_df, label_budget=5000)
fig.savefig('mse_5000-queries_accuracy_barplot.pdf', bbox_inches='tight', dpi=72)
